...
namespace XNAGameSpaceShotter.src.Primitives3D {
    ...
    public abstract class GeometricPrimitive: IDisposable {
        ...
        public void Draw(Matrix world, Matrix view, Matrix projection, Color color) {
            ...
            basicEffect.World = world;//Translation Matrix * Rotation Matrix * Scalation Matrix
        ...
        public void Draw(Matrix world, Matrix view, Matrix projection, Texture2D texture, int alpha) {
            // Set BasicEffect parameters.
            ...
            basicEffect.Alpha = alpha / 255.0f;
